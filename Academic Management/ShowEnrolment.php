...
<html>
    ...
    <body>
        ...
        <div class="table" style="width: 80%; float: right;">
            ...
            <tr>
                <td><input type="checkbox" name="code[]" value="<?= $row['Code']?>" style="margin-left:-8px;"> <?= $row['Code']?></td>
                <td><?= $row['Subject']?></td>
                <td><?= $row['Major']?></td>
                <td><?= $row['Score']?></td>
                <td><?= $row['Professor']?></td>
            ...
            <?php } ?>
            <tr>
                <td colspan="6"style="border:none;background-color: #FAFAFA; text-align:right;"><input type="submit" value="삭제" class="btn"></td> 
            </tr>
            </table>
            <?php }
            else{ ?>

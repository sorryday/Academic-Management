...
<html>
    ...
    <body>
        ...
        <div class="bar" style="width: 20%;float: left">
            <h1><?=$type?>공지</h1>
            <br>
            <a href="NoticeList.php?type=일반">일반공지</a><br>
            <a href="NoticeList.php?type=학사">학사공지</a><br>
            <a href="NoticeList.php?type=장학">장학공지</a><br>
            <a href="NoticeList.php?type=취업">취업공지</a><br>
        </div>
        <div class="table" style="width: 80%; float: right;">
            ...
            <tr>
                <td style="width: 10%"><?= $row['No']?></td>
                <td class="name" style="width: 60%;"><a href="NoticePrint.php?no=<?= $row['No']?>&type=<?= $type?>"><?= $row['Title']?></a></td>
            ...
            if($block <=1){?>
            <?php }else{?>
                <font size=4><a href="NoticeList.php?page=<?=$b_start_page-1?>&list=<?=$list?>&type=<?=$type?>">이전</a></font>
            <?php }
            ...
            <?php }
                    ...
                    <font size=4><a href="NoticeList.php?page=<?=$j?>&list=<?=$list?>&type=<?=$type?>"><?=$j?></a></font>
            <?php
                  }                
            }
            ...
            <?php }else{?>    
                <font size=4><a href="NoticeList.php?page=<?=$b_end_page+1?>&list=<?=$list?>&type=<?=$type?>">다음</a></font>
            <?php } ?>
            </div>
            <?php }
            else{ ?>

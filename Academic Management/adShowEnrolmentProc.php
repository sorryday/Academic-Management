    ...
    <body>
        ...
        <div class="table" style="width: 80%; float: right;">
            ...
            if($result->num_rows > 0) {
                ?>
            <table>
            <td colspan="4"style="border:none;background-color: #FAFAFA; text-align:left; height:150px;"><h2 style="font-family: 'Noto Sans KR', sans-serif;"><?=$Name?>님의 수강강좌</h2></td> 
            <tr>
                <th>과목코드</th>
            ...
            <?php }
                ...
                print "<script language=javascript> alert('이름과 학번이 맞지 않습니다.'); location.replace('adShowEnrolment.php'); </script>";
            }?>
        </div>
        <?php }?>
    </body>

...
<html>
    ...
    <body>
        ...
        <!-- 정보를 띄어줄 table -->
        <form action="adNoticeAddProc.php" method="post">
        ...
        <div class="table" style="width: 80%; float: right;">
            ...
            <tr>
                <th>제목</th>
                <td colspan="3"><input type="text" name="name" class="input"></td>
            </tr>
            <tr>
                <th>작성자</th>
                <td><input type="text" name="writer" value="<?=$name?>" class="input" readonly></td>
                <th>작성일</th>
                <td><input type="date" name="date" value="<?=$today?>" class="input" readonly></td>
            </tr>
            <tr>
                <td colspan="4" style="height:500px; vertical-align: top;"><textarea type="text" name="con" class="input" style="height:500px;"></textarea></td>
            </tr>
            <tr>
                <td colspan="4"style="border:none;background-color: #FAFAFA; text-align:right;"><input class="btn" type="submit" value="등록"></td>    
            </tr>
            </table>
        </div>
        </form>

...
<html>
    ...
    <body>
        ...
        <form action="adShowAcademicProc3.php" method="post" name="upd">
        <div class="table" style="width: 80%; float: right;">
            ...
            <tr>
                ...
                <td><?= $row['Birthday']?></td>
                <th>담당교수</th>
                <td><input type="text" name="pro" value="<?= $row['Professor']?>"></td>
                <th style="border-top:0px; width:200px;">총취득 학점</th>
                <td><?= $total?></td>
            </tr>
            <tr>
                <th style="border-top:0px;">단과대학</th>
                <td style="border-top:0px;"><input type="text" name="col" value="<?= $row['College']?>"></td>
                <th style="border-top:0px;">학부</th>
                <td style="border-top:0px;"><input type="text" name="depart" value="<?= $row['Department']?>"></td>
                <th style="border-top:0px;">학과</th>
                <td style="border-top:0px;"><input type="text" name="codepart" value="<?= $row['CoDepartment']?>"></td> 
            </tr>
            <?php } ?>
            <tr>
                <td colspan="6"style="border:none;background-color: #FAFAFA; text-align:right;"><input type="submit" value="수정" class="btn"></td>    
            </tr>
            </table>
            <?php } ?>
        </div>
